...
const CDSCO_A =
  "Classified Class A (low risk) under India's Medical Devices Rules, 2017. CDSCO classifies devices and licenses manufacturers and importers; it does not license rental or resale providers, and EnconeMed makes no claim of CDSCO approval.";
const CDSCO_B =
  "Classified Class B (low–moderate risk) under India's Medical Devices Rules, 2017. CDSCO does not license rental or resale providers and EnconeMed claims no CDSCO approval.";
const CDSCO_C =
  "Classified Class C (moderate–high risk) under India's Medical Devices Rules, 2017. CDSCO does not license rental or resale providers and EnconeMed claims no CDSCO approval.";
...
export const PROFILES = {
  ...
  furniture: {
    ...
    legalStatus:
      "Hospital furniture is generally outside the device classification of India's Medical Devices Rules, 2017, and is supplied as general-purpose care furniture. EnconeMed claims no CDSCO approval.",
  },
  ...
  urinaryCatheter: {
    ...
    legalStatus:
      "Urinary catheters are notified medical devices under India's Medical Devices Rules, 2017, and are supplied sterile and single-use. EnconeMed supplies them and makes no claim of CDSCO approval.",
  },
  ...
  enteralFeeding: {
    ...
    legalStatus:
      "Enteral feeding tubes are notified medical devices under India's Medical Devices Rules, 2017, supplied sterile and single-use. EnconeMed claims no CDSCO approval.",
  },
  ...
  ppe: {
    ...
    legalStatus:
      "Examination gloves and face masks are notified medical devices under India's Medical Devices Rules, 2017. Supplied as single-use items; EnconeMed claims no CDSCO approval.",
  },
