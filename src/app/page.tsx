...
const HOME_FAQS: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. Encone Care is a home nursing and medical equipment service operating since 2022 with over 100 verified nurses and attendants on its network. Across Delhi NCR, equipment and trained care can be arranged on the same call.",
  },
  {
        ...
        <Container>
          ...
          <div className="mt-8 grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
            <DisplayHeading
              align="left"
              lead="Delhi NCR."
              trail="Six cities, and nowhere else."
            />

            <div>
              <p className="text-base leading-relaxed text-text-secondary">
                We deliver only where we can install the equipment, demonstrate it,
                and get a replacement out the same night if it fails — which is
                Delhi NCR: {NCR_PINCODE_COUNT} pincodes across six cities, and
                nowhere else. We would rather tell you that than take a booking we
                cannot keep.
              </p>
              ...
              <Link
                href="/locations"
                className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-text-primary underline-offset-4 hover:underline"
              >
                Check your pincode
