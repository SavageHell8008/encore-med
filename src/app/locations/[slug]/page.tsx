  ...
  const faqs: Faq[] = [
    {
      ...
      answer: `Yes. Encone Care delivers, installs and commissions equipment across ${area.name}, usually within four hours of a confirmed order. A technician assembles the equipment and demonstrates it before leaving.`,
    },
    {
