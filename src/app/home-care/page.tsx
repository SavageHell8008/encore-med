...
const FAQS: Faq[] = [
  {
    ...
    answer:
      "Yes. Encone Care supplies both the medical equipment and the nursing services from the same phone number. A hospital bed and an attendant trained to reposition a patient in it can be arranged on one call rather than two.",
  },
  {
